    ...
    <ul>
        <li>
        	<div class="wrap">
    			...
    			<!-- <ul class="three_col">
    				<li><p>Espacios corporativos  para generar las mejores ideas, cultivar 
    			relaciones estratégicas, e inspirar la realización de proyectos excepcionales. Quadra 
    			Towers conjuga apariencia y funcionalidad para empresarios y ejecutivos enfocados en su negocio.</p></li>
    				<li><p>Espacios corporativos  para generar las mejores ideas, cultivar 
    			relaciones estratégicas, e inspirar la realización de proyectos excepcionales. Quadra 
    			Towers conjuga apariencia y funcionalidad para empresarios y ejecutivos enfocados en su negocio.</p></li>
    			<li><p>Espacios corporativos  para generar las mejores ideas, cultivar 
